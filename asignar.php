...
//Insertar Registro
$insertar = "insert into renovaciones values ('$hoy', '$piso', '$ubicacion', '$software', '$row_Rsmonitor[idmonitor]', '$row_Rsteclado[idteclado]', '$row_Rsmouse[idmouse]', '$row_Rspersona[idpersona]', '$encontrado', '$registro', '$local')";
